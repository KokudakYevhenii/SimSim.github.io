(() => {
    ...
    function initSliders() {
        ...
        if (document.querySelector(".swiper-prototype")) new Swiper(".swiper-prototype", {
            modules: [ Navigation, Autoplay ],
            observer: true,
            observeParents: true,
            slidesPerView: 3,
        ...
        if (document.querySelector(".swiper-white")) new Swiper(".swiper-white", {
            modules: [ Navigation, Autoplay ],
            observer: true,
            observeParents: true,
            slidesPerView: 5,
...
***************************************************************************** */
    ...
    for (var i = 0; i < thumbs.length; i++) thumbs[i].addEventListener("click", (function(e) {
        e.preventDefault();
    ...
    document.querySelectorAll(".fabrication__button button").forEach((button => {
        button.addEventListener("click", (function() {
            document.querySelectorAll(".fabrication__button button").forEach((btn => {
